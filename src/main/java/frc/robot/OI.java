...
public class OI {
     ...
     * == COMMANDS ==
     */
    private final Command m_DOL = new SequentialCommandGroup(new MoveDirectionPID(6.208), new TurnFullPID(122.08), new MoveDirectionPID(10), new TurnFullPID(-67.313), new TurnFullPID(123.187), new MoveDirectionPID(14.333), new TurnFullPID(-53));
    // new MoveDirection(6.208), new TurnFullPID(122.08), new MoveDirection(10.5), new TurnFullPID(-67.313), new TurnFullPID(119.187), new MoveDirection(15.833), new TurnFullPID(-53)
